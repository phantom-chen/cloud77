...
namespace Cloud77.Abstractions.Utility
{
    public class CodeGenerator
    {
        ...
        public static string GenerateVerificationCode(string email, DateTime date, int saltLength = 6)
        {
            return HashString(email.ToLower() + date.Millisecond.ToString() + GenerateDigitalCode(saltLength));
        }
