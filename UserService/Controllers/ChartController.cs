...
namespace UserService.Controllers
{
    ...
    public class ChartController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("chat/2all")]
        public IActionResult Hello2All()
        {
            hub.Clients.All.SendAsync("hub2all", "hello using api controller");
            return Ok(new ServiceResponse("broadcast-message", "", "Broadcase message"));
        }

        [HttpPost]
        [Route("chart")]
        public IActionResult StartLiveChart()
        {
        ...
        [HttpDelete]
        [Route("chart")]
        public IActionResult StopLiveChart()
        {
            if (manager.IsTimerStarted)
            {
                manager.StopTimer();
